...
for line in fh:                                                                            # lee c/linea del file (es decir c/CRLF es una linea)                
    ...
    pieces = line.split()                                                                  # busca el 'space' p separa las palabras en un arreglo, la idea es buscar en la BD si existe este e-mail, sino existe lo INSERTA si existe lo ACTUALZA.
