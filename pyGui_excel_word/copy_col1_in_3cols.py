...
import openpyxl
workbook = openpyxl.load_workbook('example.xlsx',read_only=False)           # Load the Excel workbook
...
nro_col =int(len(src_cell)/4)
final_col = len(src_cell)%4                                             # es lo mismo = len(src_cell) - nro_col*4 
print("Separo en 4 cols = ",nro_col, "   ultima col = ",final_col)      # final_col debe tener nro_col + final_col  
