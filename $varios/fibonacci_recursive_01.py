...
# Fibonacci en DECIMAL.
r = fibonacci(0.1,20)
for i in r:
    print('{:.2f}'.format(i), end=' ')  # 0.10 0.20 0.30 0.50 0.80 1.30 2.10 3.40 5.50 8.90 14.40 23.30 37.70 61.00 98.70 159.70 258.40 418.10 676.50 1094.60         
